...
export default function Header() {
  ...
  return (
    <header className={`fixed w-full bg-white dark:bg-gray-900 shadow-md z-50 transition-all duration-300 ${isScrolled ? 'py-2' : 'py-3'}`}>
      <div className="container mx-auto px-4 flex justify-between items-center">
        <Link href="#home" className="flex items-center space-x-2">
          <span className="text-primary text-3xl">
            <MicrochipIcon className="h-8 w-8" />
          </span>
          <span className="text-foreground font-heading font-bold text-xl">TechCore Solutions</span>
        </Link>
